-- =============================================================================
-- WRINDHAOS COMPLETE PRODUCTION-READY SUPABASE DATABASE SCHEMA v4.3.0
...
--   3. Comprehensive Column Name Aliasing (camelCase, snake_case, legacy UI fields)
--   4. All 12 production modules supported (Profiles, Subscriptions, Payments, 
