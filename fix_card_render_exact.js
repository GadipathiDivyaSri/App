...
const replacementQk = `qK(a,b,c,d,e){
...
var textColWidget=A.ab(A.b([titleW,B.aJ,subW],r),B.w,B.h,B.f,0,B.o);
var cardColWidget=A.ab(A.b([s,textColWidget],r),B.w,B.aC,B.f,0,B.o);
var cardContainer=A.a4(q,cardColWidget,B.m,q,new A.a0(o,q,q,n,m,q,B.r),q,q,q,B.cK,q,q,q);
return A.c2(q,cardContainer,B.t,!1,q,q,q,q,q,q,q,q,q,q,q,q,q,q,q,q,c,q,q,q,q,q,q);
}`.replace(/\n/g, '');
...
console.log('Replacing from', qkPos, 'to', qkEnd);
js = js.substring(0, qkPos) + replacementQk + js.substring(qkEnd);

fs.writeFileSync('build/web/main.dart.js', js, 'utf8');
console.log('Saved perfect card builder in build/web/main.dart.js');
