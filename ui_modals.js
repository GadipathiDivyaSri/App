...
(function() {
  window._openFocusTimerModal = function(ctx) {
    var isDark = (document.body.style.backgroundColor === 'rgb(30, 31, 43)' || (window._isDarkMode === true));
    var totalSec = 25 * 60;
        ...
        <div style="background: ${isDark ? '#1E1F2B' : '#FFF9F0'}; color: ${isDark ? '#FFF' : '#1E293B'}; width: 90%; max-width: 500px; border-radius: 28px; padding: 28px; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.35); border: 1px solid ${isDark ? '#2D2F3F' : '#E2E8F0'}; max-height: 90vh; overflow-y: auto;">
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
            <div style="display: flex; align-items: center; gap: 10px;">
              ...
              <div>
                <h2 style="margin: 0; font-size: 18px; font-weight: 800;">3-Tier Goal Pyramid</h2>
                <p style="margin: 0; font-size: 12px; color: #64748B;">Short, Medium & Long-Term Targets</p>
              </div>
            </div>
          ...
          <div style="display: flex; gap: 8px; margin-bottom: 18px;">
            ...
            <button id="btn_add_goal" style="background: #E87552; color: white; border: none; padding: 12px 18px; border-radius: 12px; font-weight: 800; cursor: pointer;">+ Add</button>
          </div>
